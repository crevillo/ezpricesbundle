...
namespace Crevillo\EzPricesBundle\eZ\Publish\Core\FieldType;
 ...
 */
abstract class LegacyKernelBasedStorage implements FieldStorage
{
    /**
     * Gateways
     *
     ...
     * @param \Crevillo\EzPricesBundle\eZ\Publish\Core\FieldType\LegacyKernelGateway $gateway
     *
     * @return void
     */
    public function addGateway( $identifier, LegacyKernelGateway $gateway )
    {
     ...
     * @param array $context
     *
     * @return \Crevillo\EzPricesBundle\eZ\Publish\Core\FieldType\LegacyKernelGateway
     */
    protected function getGateway( array $context )
    {
        ...
        $gateway->setLegacyKernel( $context['connection'] );
